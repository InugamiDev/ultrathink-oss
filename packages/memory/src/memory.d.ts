...
export type MemoryRelationType = "learned-from" | "contradicts" | "supports" | "applies-to" | "caused-by" | "supersedes" | "related_to";
/**
...
export declare function updateMemory(id: string, updates: Partial<Pick<Memory, "content" | "category" | "importance" | "confidence" | "scope" | "is_archived">>): Promise<Memory | null>;
...
export declare function createRelation(sourceId: string, targetId: string, relationType?: string, strength?: number): Promise<void>;
export declare function getRelations(memoryId: string, opts?: {
    includeHistory?: boolean;
}): Promise<MemoryRelation[]>;
export declare function getMemoryGraph(opts?: {
    scope?: string;
    limit?: number;
}): Promise<{
    nodes: Memory[];
